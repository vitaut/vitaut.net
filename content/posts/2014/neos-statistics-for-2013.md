...
2013 is over so it's time to report the annual [NEOS Server](https://www.neos-server.org/neos/)
statistics again.
...
[previous year](https://zverovich.net/2013/01/01/neos-statistics-for-2012.html).
